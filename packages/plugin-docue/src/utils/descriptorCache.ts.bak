...
import type { CompilerError, SFCDescriptor } from 'docuejs/compiler-sfc'
import type { ResolvedOptions, DocueQuery } from '..'
...
// transformed by other plugins, e.g. docue-macros;
...
export function setSrcDescriptor(
  ...
  if (scoped) {
    // if multiple Docue files use the same src file, they will be overwritten
