...
//     editFile('PreProcessors.docue', (code) =>
...
//     editFile('PreProcessorsHmr.docue', (code) =>
//       code
...
//     editFile('CssModules.docue', (code) =>
...
//     editFile('Hmr.docue', (code) => code.replace('HMR', 'HMR updated'))
...
//     editFile('Hmr.docue', (code) => code.replace('color: red;', 'color: blue;'))
...
//     editFile('Hmr.docue', (code) => code.replace(/<template>.+<\/template>/s, ''))
//     await untilUpdated(() => page.innerHTML('.hmr-block'), '<!---->')
//   })

//   test('should re-render when template and tsx script both changed', async () => {
//     editFile('HmrTsx.docue', (code) => code.replace(/count/g, 'updatedCount'))
//     await untilUpdated(
...
// describe('docue worker', () => {
//   test('should work', async () => {
//     expect(await page.textContent('.docue-worker')).toMatch('worker load!')
//   })
// })
